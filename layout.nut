...
class UserConfig {
   ...
   </ label="Enable monitor static effect", help="Show static effect when snap is null", options="No", order=8 /> enable_static="No";
...
surface_snap.set_pos(flx*0.2786, fly*0.25, flw*0.2187, flh*0.5925 );
...
//adjust the values below for the static preview video snap
   ...
   local snapbg=null;
   snapbg = fe.add_image( "static.mp4", flx*0.2786, fly*0.2571, flw*0.2187, flh*0.5925 );
...
{
//Year text info
local texty = fe.add_text("[Year]", flx*0.38, fly*0.937, flw*0.13, flh*0.055 );
texty.set_rgb( 255, 255, 255 );
//texty.style = Style.Bold;
//texty.align = Align.Left;

//Title text info
local textt = fe.add_text( "[Title]", flx*0.515, fly*0.955, flw*0.6, flh*0.025  );
...
local glogo1 = fe.add_image("glogos/unknown1.png", flx*0.32, fly*0.945, flw*0.045, flh*0.05);
